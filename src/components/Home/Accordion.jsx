...
function Accordion() {
  ...
  return (
    ...
    >
      <h3
        className="text-4xl font-bold text-center text-black-700 mb-6"
        data-aos="zoom-in"
      >
        Fun FAQ for Kids
      </h3>
      ...
      <div
        className="collapse collapse-arrow bg-purple-50 border-2 border-gray-200 rounded-xl hover:bg-purple-100 transition-all duration-300"
        data-aos="fade-right"
      >
        <input type="radio" name="kids-accordion" defaultChecked />
        <div className="collapse-title text-lg font-semibold text-black-700">
